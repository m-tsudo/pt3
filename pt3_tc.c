...
#if 0
	PT3_PRINTK(7, KERN_DEBUG "PT3: read_tuner_without tc_addr=0x%x tuner_addr=0x%x\n",
...
#if 0
	PT3_PRINTK(7, KERN_DEBUG "PT3: read_tuner tc_addr=0x%x tuner_addr=0x%x\n",
			tc->tc_addr, tc->tuner_addr);
#endif
...
#if 0
	PT3_PRINTK(7, KERN_DEBUG "PT3: time diff = %d\n", diff / 1000);
#endif
	return diff / 1000;
}
